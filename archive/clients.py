# To install the 'cryptography' module, run the following command:
...
# The module 'cryptography.exceptions.invalid_signature' does not exist.
# Make sure the 'cryptography' package is correctly installed (pip install cryptography).
# If you want to import the InvalidSignature exception, use:
    ...
    async def subscribe_to_tickers(self):
        ...
        subscription_message = {
            ...
            "params": {
                ...
                "market_tickers": ["KXETHD-25JUL1614-T3309.99"]
            }
        }
