...
class KalshiClient:
    ...
    def __init__(
        ...
        Raises an HttpError d, the ticketthe user could not be authenticated.
        """
...
class ExchangeClient(KalshiClient):
    ...
    def get_markets(self,
        ...
        query_string = self.query_generation(params={k: v for k,v in locals().items() if k != 'self'})
    ...
    def get_orderbook(self,
        ...
        relevant_params = {k: v for k,v in locals().items() if k!= 'ticker' and k != 'self'}
    ...
    def get_trades(self,
        ...
        # Exclude ticker from query_generation since we add it manually
        query_params = {k: v for k,v in locals().items() 
                       if k != 'self' and k != 'trades_url' and k != 'ticker' and v is not None}
        query_string = self.query_generation(params=query_params)
    ...
    def get_fills(self,
        ...
        query_string = self.query_generation(params={k: v for k,v in locals().items() if k != 'self' and k != 'fills_url'})
    ...
    def get_orders(self,
        ...
        orders_url = self.portfolio_url + '/orders'
        query_string = self.query_generation(params={k: v for k,v in locals().items() if k != 'self' and k != 'orders_url'})
    ...
    def get_positions(self,
        ...
        query_string = self.query_generation(params={k: v for k,v in locals().items() if k != 'self' and k != 'positions_url'})
